					...
					<div class="login-form">
						...
						<form>
							<div class="mb-4">
								...
								<input type="email" class="form-control form-control" placeholder="Enter your email address or username">
							</div>
							<div class="mb-4 position-relative">
								<label class="mb-1 text-dark">Password</label>
								<input type="password" id="dz-password" class="form-control" placeholder="Enter your password">
